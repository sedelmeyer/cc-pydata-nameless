"""
cc_pydata_nameless.logger
~~~~~~~~~~~~~~~~~~~~~~~~~

This module contains logging-related features for the ``cc_pydata_nameless`` package
...
def start_logging(
    ...
    """Set up logging configuration for ``cc_pydata_nameless`` package
