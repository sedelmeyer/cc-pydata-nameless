...
from cc_pydata_nameless import logger
...
class TestStartLogging(TestCase):
    ...
    def setUp(self):
        ...
        patcher = mock.patch('cc_pydata_nameless.logger.json.load')
    ...
    def test_start_logging_basicConfig(self):
        ...
        with mock.patch(
            'cc_pydata_nameless.logger.logging.basicConfig'
    ...
    def test_start_logging_dictConfig(self):
        ...
        with TemporaryDirectory() as tmp:
            ...
            open(fp, 'a').close()
            with mock.patch(
                'cc_pydata_nameless.logger.logging.config.dictConfig'
            ) as dictConfig_patch:
